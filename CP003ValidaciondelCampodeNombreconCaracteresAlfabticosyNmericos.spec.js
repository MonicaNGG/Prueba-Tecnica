...
describe('CP003-Validación del Campo de Nombre con Caracteres Alfabéticos y Númericos', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('CP003-Validación del Campo de Nombre con Caracteres Alfabéticos y Númericos', async function() {
    // Test name: CP003-Validación del Campo de Nombre con Caracteres Alfabéticos y Númericos
    ...
    // 5 | type | id=full-name | Monica 1234
    await driver.findElement(By.id("full-name")).sendKeys("Monica 1234")
    // 6 | click | id=email | 
